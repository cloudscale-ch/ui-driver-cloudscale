...
| Key | Value |
| --- | ----- |
| Download URL | `https://github.com/cloudscale-ch/docker-machine-driver-cloudscale/releases/download/v1.0.0-rc1/docker-machine-driver-cloudscale_v1.0.0-rc1_linux_amd64.tar.gz` |
